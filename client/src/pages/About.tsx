            ...
            <Card className="border-secondary/30">
              <CardContent className="pt-8">
                <p className="text-lg text-foreground/80 text-center leading-relaxed mb-8">
                  Pulse is built by a diverse team of blockchain developers,
                  security experts, designers, and community managers from
                  around the world. Our team has decades of combined experience
                  in cryptocurrency, DeFi, and traditional finance.
                </p>
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <p className="text-foreground/70">
                      Experienced blockchain engineers building secure, scalable
                      infrastructure
                    </p>
                  </div>
                  <div className="text-center">
                    ...
                    <p className="text-foreground/70">
                      Dedicated security professionals ensuring the safety of
                      user funds
                    </p>
                  </div>
                  <div className="text-center">
                    ...
                    <p className="text-foreground/70">
                      Passionate community managers supporting our global user
                      base
                    </p>
                  </div>
                </div>
