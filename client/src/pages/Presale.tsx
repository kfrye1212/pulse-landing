...
export default function Presale() {
  ...
  const { address, isConnected, chain, balance, connect, disconnect } = useWallet();
  ...
  const handleContribute = () => {
    ...
    alert(`Contributing ${amount} ${selectedToken} from ${address?.slice(0, 6)}...${address?.slice(-4)}\n\nSmart contract integration coming soon!`);
  };
        ...
        <div className="container">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-foreground/70 max-w-2xl mx-auto">
              Join the early adopters and secure your PULSE tokens at exclusive presale prices
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <Card className="border-primary/30">
                <CardHeader>
                  <CardTitle className="text-2xl">Contribute to Presale</CardTitle>
                  <CardDescription>
                ...
                <CardContent className="space-y-6">
                      ...
                      <div className="space-y-3">
                        <div className="bg-primary/10 border border-primary/30 rounded-lg p-4">
                          <div className="flex items-center justify-between mb-2">
                            <span className="text-sm text-foreground/70">Connected Wallet</span>
                  ...
                  <div className="border-t border-border pt-6">
                    {/* Token Selection */}
                    <div className="mb-6">
                      <Label className="text-base mb-3 block">Select Payment Token</Label>
                      <div className="grid grid-cols-4 gap-3">
                        {["ETH", "USDC", "USDT", "SOL"].map((token) => (
                          <Button
                            key={token}
                            variant={selectedToken === token ? "default" : "outline"}
                            className={selectedToken === token ? "bg-primary" : ""}
                    ...
                    <div className="bg-card/50 p-4 rounded-lg mb-6">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-2xl font-bold text-gradient">
                          {amount ? (parseFloat(amount) * 1000).toLocaleString() : "0"} PULSE
                        </span>
                      </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <div className="font-semibold">TGE (Token Generation Event)</div>
                        <div className="text-sm text-foreground/60">20% unlocked immediately</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <div className="font-semibold">Linear Vesting (6 months)</div>
                        <div className="text-sm text-foreground/60">80% unlocked gradually over 6 months</div>
                      </div>
                    </div>
                  </div>
                </CardContent>
            ...
            <div className="space-y-6">
                ...
                <CardContent className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-foreground/60">40% discount vs public sale</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-foreground/60">Fair launch mechanism</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-foreground/60">Priority features & governance</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-accent/30 bg-accent/5">
                ...
                <CardContent>
                  <p className="text-sm text-foreground/70">
                    All smart contracts have been audited by leading security firms. 
                    Liquidity will be locked for 2 years post-TGE.
                  </p>
                </CardContent>
              </Card>
